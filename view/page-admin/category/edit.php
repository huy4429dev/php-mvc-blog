                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <div class="row" style="margin:auto;padding-bottom:3rem">
                            <div class="col-md-12">
                                <form role="form" method="POST" action='<?php echo (adminUrl('CategoryController', "update&id=$category->id"))  ?>' enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Tiêu đề</label>
                                            <input required type="text" class="form-control" id="product-name" placeholder="Tiêu đề" name="name" value="<?php echo($category->name) ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea required type="text" class="form-control" id="product-name" name="description" ><?php echo($category->description) ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
